...
const char *DSPTargetLowering::getTargetNodeName(unsigned Opcode) const {
	...
	case DSPISD::VMAX10: return "DSPISD::VMAX10"; break;
	case DSPISD::VMAX20: return "DSPISD::VMAX20"; break;
	case DSPISD::VMAX40: return "DSPISD::VMAX40"; break;
	case DSPISD::VMIN10: return "DSPISD::VMIN10"; break;
	case DSPISD::VMIN20: return "DSPISD::VMIN20"; break;
	case DSPISD::VMIN40: return "DSPISD::VMIN40"; break;
...
static SDValue LowerINTRINSIC_WO_CHAIN(SDValue Op, SelectionDAG &DAG) {
	...
	case Intrinsic::dsp_vmax_10:
		return DAG.getNode(DSPISD::VMAX10, dl, Op.getValueType(),
			Op.getOperand(1), Op.getOperand(2));
	case Intrinsic::dsp_vmax_20:
		return DAG.getNode(DSPISD::VMAX20, dl, Op.getValueType(),
			Op.getOperand(1), Op.getOperand(2));
	case Intrinsic::dsp_vmax_40:
		return DAG.getNode(DSPISD::VMAX40, dl, Op.getValueType(),
			Op.getOperand(1), Op.getOperand(2));
	case Intrinsic::dsp_vmin_10:
		return DAG.getNode(DSPISD::VMIN10, dl, Op.getValueType(),
			Op.getOperand(1), Op.getOperand(2));
	case Intrinsic::dsp_vmin_20:
		return DAG.getNode(DSPISD::VMIN20, dl, Op.getValueType(),
			Op.getOperand(1), Op.getOperand(2));
	case Intrinsic::dsp_vmin_40:
		return DAG.getNode(DSPISD::VMIN40, dl, Op.getValueType(),
			Op.getOperand(1), Op.getOperand(2));
	}
}
...
SmallVectorImpl<SDValue> &InVals) const {
	...
	DSPFunctionInfo *Cpu0FI = MF.getInfo<DSPFunctionInfo>();
	...
	DSPCC Cpu0CCInfo(CallConv, Subtarget.isABI_O32(),
	...
	*/
	...
	DSPCC::byval_iterator ByValArg = Cpu0CCInfo.byval_begin();
...
const Type *RetTy) const {
	...
	DSPCC Cpu0CCInfo(CallConv, Subtarget.isABI_O32(), CCInfo);
